...
class ErrorsTableRenderTest(unittest.TestCase):
    """failures_table() renders the reliability block inside #pricing."""
    ...
    def _payload(self, failures):
        return {"range": "30d", "requests_scanned": 10, "routes": {}, "failures": failures}
    ...
    def test_clean_window_gets_ok_chip(self):
        failures = {"total": 5, "failed": 0, "rate_pct": 0.0, "codes": {},
