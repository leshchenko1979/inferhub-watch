...
|---|---|---|---|---|---|
| 1 | Repository & CI/CD | 2026-09-12 03:00Z | 03:00Z cycle / #18 | HEALTHY | Push runs verify `Watch — site deploy` (live: runs 34670257352 et al.); criterion 3 gate moved to ~07:19Z — see Class 4 |
| 2 | Data & Storage | 2026-09-12 04:00Z | 04:00Z cycle / #25 | HEALTHY | #25 landed (540f435): hourly `GET /api/catalog` live, 115 routes updated in route_metrics (03:24Z), catalog_source=live_api |
| 3 | Surfaces (Web, Grafana, Telegram) | 2026-09-12 04:00Z | 04:00Z cycle / #23 | HEALTHY | 24/24 panels valid via live `test_grafana_panels.py` probe (0 errors), Pages 200 (122.4 KB) |
...
| 5 | Code & Config | 2026-09-12 04:00Z | 04:00Z cycle / #25 | HEALTHY | Live catalog overlay in auto_route_switch + route_metrics sync, 572 tests pass |
